...
- [trackmd](https://github.com/ropenscilabs/trackmd) is similar to `reviewer`, but:
  ...
  - shows changes in the *rendered* rmarkdown file (i.e. once it has been converted to its HTML document format). `reviewer` shows changes in the raw rmarkdown document.
